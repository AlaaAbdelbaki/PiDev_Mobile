...
public class TunisiaGotTalent {
  ...
  private void showSplashAnimation() {
        ...
        ScaleImageLabel iconBackground = new ScaleImageLabel(theme.getImage("mp4.jpg"));
        ...
        Label iconForeground = new Label(theme.getImage("logo.png"));
        ...
        callSerially(() -> {
            ...
            Label kitchenSink = new Label("Welcome", "SplashTitle");
            ...
            callSerially(() -> {
                ...
                Label byCodenameOne = new Label("by KingPins", "SplashSubTitle");
                ...
                int maskHeight = mask.getHeight() / 4 * 3;
                ...
                Object imageMask = top.createMask();
                
                Image circleMaskImage = theme.getImage("round-mask.png");
                Object circleMask = circleMaskImage.createMask();
                int circleMaskWidth = circleMaskImage.getWidth();
                int circleMaskHeight = circleMaskImage.getHeight();
                
                Image[] colorBottoms = new Image[7];
                int[] colors = new int[colorBottoms.length];
